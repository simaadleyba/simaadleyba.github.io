  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        ensemblelearning: resolve(__dirname, 'ensemblelearning/index.html'),
        svm: resolve(__dirname, 'svm/index.html'),
        clustering: resolve(__dirname, 'clustering/index.html'),
        spectralclustering: resolve(__dirname, 'spectralclustering/index.html'),
        pca: resolve(__dirname, 'pca/index.html'),
        neuralnetworks: resolve(__dirname, 'neuralnetworks/index.html'),
      },
    },
  },
})
